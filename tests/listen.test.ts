...
//
//   await superdeno(`http://localhost:${server}`)
//     .get("/")
...
// });
//
// Deno.test("Handles listen on assigned port", async () => {
//   const app = new Deroutex();
//
//   app.get("/", (ctx) => {
//     ctx.body = new JsonBody({ name: "john" });
...
//
//   await superdeno(`http://localhost:${port}`)
//     .get("/")
//     .expect("Content-Type", /json/)
//     .expect("Content-Length", "15")
//     .expect(200);
...
// });
//
// Deno.test("Handles listen on assigned string port", async () => {
//   const app = new Deroutex();
//
//   app.get("/", (ctx) => {
//     ctx.body = new JsonBody({ name: "john" });
...
// });
//
// Deno.test("Catches listen on invalid port", async () => {
//   const app = new Deroutex();
//
//   app.get("/", (ctx) => {
//     ctx.body = new JsonBody({ name: "john" });
...
// });
//
// Deno.test("Catches listen on invalid hostname", async () => {
//   const app = new Deroutex();
//
//   app.get("/", (ctx) => {
//     ctx.body = new JsonBody({ name: "john" });
...
// });
//
// Deno.test("Handles HTTPS listen", async () => {
...
//   });
//
//   await superdeno(`https://localhost:${port}`)
//     .get("/")
